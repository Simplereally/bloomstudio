...
/**
 * Calculates a clamped aspect ratio to prevent extreme dimensions in the UI.
 * Useful for displaying images that might have "weird" or extreme aspect ratios.
 * 
 * @param width Image width
 * @param height Image height
 * @param min Minimum aspect ratio (default: 0.4 which is approx 1:2.5)
 * @param max Maximum aspect ratio (default: 2.5 which is 5:2)
 * @returns The clamped aspect ratio value
 */
