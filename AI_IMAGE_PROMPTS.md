...
- **Hero Section (Carousel):** 9:16 (Portrait)
- **Feature Section:** 16:9 (Landscape)
- **Showcase Section:** 16:9 (Landscape)

---

## 1. AI Blueprints

**Context:** Architectural visualizations, floor plans, schematics, and technical drafting.

### Hero Section (Carousel)

**Ratio:** 9:16 (Portrait)

1. A high-resolution architectural blueprint of a modern sustainable skyscraper, white lines on a classic deep blue background, showing intricate structural details and floor layouts with technical annotations.
2. A clean, white-on-black CAD style drawing of a complex mechanical gear assembly, demonstrating precision engineering and technical drafting aesthetics with dimension lines.
3. An isometric view of a modern residential home floor plan, rendered in a blueprint style with cyan lines on a dark grid background, highlighting spatial flow and room organization.
4. A schematic cross-section of an eco-friendly building showing green energy systems, ventilation flows, and structural layers, presented in a professional architectural line-art style.

### Feature Section

**Ratio:** 16:9 (Landscape)

1. **Visual Schematics:** A detailed top-down architectural floor plan of a luxury apartment, rendered in a clean, high-contrast black and white style, clearly labeling functional zones like the kitchen, living area, and master suite with professional drafting fonts.
2. **Drafting Aesthetics:** A close-up macro shot of a digital architectural drawing, focusing on the crisp quality of the lines and ANSI standard symbols, resembling a high-end vector illustration on a textured paper background.
3. **Rapid Layout Iteration:** A split-screen composition showing three variations of a commercial office layout, each with different desk arrangements and meeting room configurations, sketched in a loose but readable conceptual architectural style.

### Showcase Section

**Ratio:** 16:9 (Landscape)

1. **Modern Floor Plan Concept:** A polished, minimalist 2D floor plan of a contemporary open-concept house, using soft pastel colors to differentiate rooms, with subtle drop shadows to create depth, viewed from directly above.
2. **Technical Style Cross-section:** A highly detailed architectural section cut of a museum building, revealing the internal galleries, staircases, and structural trusses, rendered in a precise technical style with hatching patterns.
3. **Electrical Schematic Aesthetic:** An intricate electrical circuit diagram for a smart home automation system, featuring standardized symbols for sensors and switches connected by clean, color-coded wiring paths on a dark background.
4. **Site Layout Visualization:** A landscape architecture site plan for a public park, illustrating winding pathways, water features, and tree canopies using a blend of technical line work and watercolor-style textures.
5. **3D Massing Study Render:** An isometric view of an urban city block composed of white clay-like massing models, focusing on building volumes, shadows, and urban density without surface textures, set in a bright studio lighting environment.

---

## 2. AI Image Generator

**Context:** General high-quality image generation, diverse styles, photorealism to surrealism.

### Hero Section (Carousel)

**Ratio:** 9:16 (Portrait)

1. A hyper-realistic portrait of a futuristic astronaut with a reflective gold visor, standing on a neon-lit alien landscape with twin moons in the purple sky, showcasing extreme detail and lighting effects.
2. A whimsical digital painting of a floating island city held up by giant balloons, steampunk aesthetic with brass gears and clouds, soft warm lighting and painterly textures.
3. A cinematic wide shot of a cyberpunk street market in Tokyo at night, rain slicked streets reflecting neon signs, highly detailed crowds and futuristic vehicles in a blade runner style.
4. A serene, photorealistic landscape of a misty mountain lake at sunrise, with crystal clear water reflections and vibrant autumn foliage, captured with a wide-angle lens aesthetic.

### Feature Section

**Ratio:** 16:9 (Landscape)

1. **Multi-Model Choice:** A collage-style image featuring a split face of a tiger, where one third is a pencil sketch, one third is a low-poly 3D render, and the final third is a hyper-realistic photograph, symbolizing the variety of available AI models.
2. **Prompt Enhancement:** A visual metaphor showing a rough glowing sketch of a castle transforming into a magnificent, detailed fortress with banners and lighting, representing the evolution from a simple idea to a complex output.
3. **Indistinguishable Quality:** An extreme close-up macro photograph of a human eye, capturing the intricate details of the iris, the reflection of a studio light, and skin texture, demonstrating photorealistic quality that rivals a high-end camera.

### Showcase Section

**Ratio:** 16:9 (Landscape)

1. **Cyberpunk Cityscape:** A breathtaking futuristic city skyline at night, dominated by towering mega-structures and holographic advertisements, bathed in cyan and magenta neon light with flying cars weaving through the smog.
2. **Ethereal Forest Path:** A magical forest scene with glowing bioluminescent mushrooms and ancient trees, a winding path illuminated by fireflies leading into the deep woods, rendered in a dreamy, soft-focus fantasy style.
3. **Gothic Cathedral Interior:** The grand interior of a gothic cathedral, featuring towering stone arches, intricate stained glass windows casting colorful light patterns on the floor, and dust motes dancing in the sunbeams.
4. **Sci-Fi Starship Bridge:** The command deck of a high-tech starship, sleek white surfaces with holographic interface displays, looking out into a vibrant nebula and star field through a massive panoramic window.
5. **Mystical Mountain Peak:** A majestic snow-capped mountain peak rising above a sea of clouds, illuminated by the golden light of a setting sun, with a lone climber standing at the summit for scale.

---

## 3. AI Art Generator

**Context:** Artistic styles, digital painting, oil painting, creative expression.

### Hero Section (Carousel)

**Ratio:** 9:16 (Portrait)

1. A vibrant oil painting of a bustling 19th-century Parisian street cafe, impressionist style with thick brushstrokes and dappled light, reminiscent of Renoir or Monet.
2. A surreal digital art piece featuring a giant clock melting over a desert landscape, inspired by Salvador Dali, with dreamlike colors and impossible geometry.
3. A dynamic anime-style illustration of a warrior character with a glowing sword, cel-shaded with dramatic action lines and vibrant special effects.
4. A classical watercolor landscape of a rolling vineyard in Tuscany, soft washes of green and ochre, with a rustic stone farmhouse in the distance.

### Feature Section

**Ratio:** 16:9 (Landscape)

1. **Infinite Styles:** A gallery wall composition displaying four distinct framed artworks: a pop-art soup can, a cubist portrait, a baroque still life, and a minimalist line drawing, showcasing the breadth of artistic styles.
2. **Character & World Building:** A concept art character sheet featuring a fantasy rogue in three different poses, along with small inset sketches of their weapons and accessories, set against a parchment-textured background.
3. **Creative Brainstorming:** A surreal, double-exposure portrait of an artist's profile where the mind is an explosion of vibrant paint splashes, floating renaissance sculptures, and digital glitch artifacts, symbolizing the chaotic beauty of creative flow.
...
**Context:** Motion graphics, video clips, animation, cinematic movement.
...
## 5. Transparent PNG Generator

**Context:** Isolated objects, game assets, alpha channel, stickers, UI elements.

### Hero Section (Carousel)

**Ratio:** 9:16 (Portrait)

1. A collection of colorful, glossy 3D icons floating in mid-air against a checkerboard background (representing transparency), including a rocket, a heart, and a shield.
2. A high-resolution cutout of a vintage leather camera, perfectly isolated with no background, showing crisp edges and realistic shadows.
3. A fantasy game asset of a magical potion bottle glowing with blue liquid, isolated on a transparent background, ready for a video game inventory.
4. A set of vibrant tropical fruit stickers (pineapple, watermelon, kiwi) arranged artistically, each with a white die-cut border, floating against a transparent backdrop.
...
**Context:** Ad creatives, social media visuals, marketing campaigns, brand assets.
...
1. **Creative Exploration:** A grid of four different ad variations for the same sneaker product, each with a different color scheme, background, and layout style, showcasing rapid A/B testing concepts.
2. **Social Media Graphics:** A smartphone screen displaying a vibrant Instagram story feed, featuring a bold sale announcement with eye-catching typography and dynamic background graphics.
3. **Marketing Campaign Concepts:** A mood board layout pinned with color swatches, lifestyle photos, and typography samples, representing the visual direction for a summer fashion campaign.

### Showcase Section

**Ratio:** 16:9 (Landscape)

1. **Instagram Ad Creative:** A square aspect ratio image designed for an Instagram feed, featuring a trendy coffee shop scene with a latte art focus and overlay text saying "Morning Brew".
2. **Facebook Banner Ad:** A wide landscape banner designed for Facebook, promoting a tech webinar with a modern workspace background and a "Register Now" button graphic.
3. **Product Marketing Shot:** A heroic studio shot of a pair of running shoes suspended in mid-air, with dynamic lighting and a blurred track background, screaming performance and speed.
4. **Hero Website Image:** A wide, immersive header image for a travel agency website, showing a breathtaking panorama of a tropical beach resort with clear blue water and white sand.
5. **Brand Pattern Design:** A seamless repeating pattern composed of geometric shapes and company logo elements, using a corporate color palette, suitable for packaging or website backgrounds.

---

## 7. AI Graphic Design

**Context:** Logos, icons, patterns, layouts, vector-style illustrations.
...
1. **Logo & Brand Ideation:** A sketchbook page filled with dozens of rough pencil sketches of different logo concepts for a coffee brand, ranging from cups to beans to steam swirls.
2. **Cohesive Iconography:** A collection of 12 distinct UI icons (home, settings, user, etc.) all sharing the same rounded corner style and blue gradient fill, displayed neatly on a white artboard.
3. **Pattern Exploration:** Three vertical strips showing different variations of a floral pattern, one with pastel colors, one with dark moody tones, and one high-contrast black and white.

### Showcase Section

**Ratio:** 16:9 (Landscape)

1. **Minimalist Logo Mark:** A sleek, abstract logo symbol consisting of two interlocking circles forming an infinity loop, rendered in a metallic silver gradient on a matte black business card.
2. **Custom Icon Set:** A set of flat, colorful vector icons depicting travel items like a suitcase, plane, passport, and camera, styled with simple shapes and vibrant solid colors.
3. **Branding Guidelines Visual:** A brand style guide page showing a primary logo, a color palette with hex codes, and font hierarchy examples, laid out in a clean, professional grid.
4. **Vector Style Illustration:** A flat vector illustration of a workspace desk with a laptop, plant, and coffee cup, using a limited color palette and clean shapes without outlines.
5. **Typographic Badge concept:** A vintage-style circular badge design for a "Premium Quality Coffee" brand, featuring retro typography, ribbons, and star embellishments in gold and dark brown.

---

## 8. AI Print on Demand

**Context:** Merchandise, t-shirts, mugs, posters, high-resolution prints.

### Hero Section (Carousel)

**Ratio:** 9:16 (Portrait)

1. A photorealistic mockup of a white t-shirt hanging on a wooden hanger, featuring a vibrant, detailed graphic of a retro sunset and palm trees.
2. A cozy lifestyle shot of a person holding a ceramic coffee mug with a funny, colorful cat illustration printed on it.
3. A framed art poster hanging in a modern living room, displaying a bold, abstract geometric design in black and gold.
4. A flat-lay of various merchandise items including stickers, a tote bag, and a phone case, all matching a cohesive floral pattern design.

### Feature Section

**Ratio:** 16:9 (Landscape)

1. **Merchandise Concepts:** A split screen showing a digital design of a skull graphic on the left, and a realistic mockup of that same design printed on a black hoodie on the right.
2. **High-Resolution Output:** A close-up zoom view of a printed canvas texture, showing the incredible sharpness and detail of the ink, with a magnifying glass graphic highlighting the 4K quality.
3. **Scaling Your Store:** A visualization of an online store inventory screen, filled with thumbnails of different t-shirt designs, representing a large volume of diverse products.

### Showcase Section

**Ratio:** 16:9 (Landscape)

1. **T-Shirt Graphic Design:** A cool, streetwear-style t-shirt graphic featuring a Japanese cyberpunk character with glitch effects and kanji text, isolated on a plain background.
2. **Mug & Product Print:** A wrap-around design for a coffee mug featuring a watercolor painting of a mountain landscape, shown flattened out to reveal the full image.
3. **Poster Art Print:** A vintage travel poster design for "Mars Colony", featuring retro rocket ships and red landscapes in a 1950s screen print style.
4. **Repeat Pattern Merch:** A seamless pattern of cute fast food items (burgers, fries, soda) in a kawaii style, suitable for printing on a backpack or tote bag.
5. **Sticker Pack Elements:** A sheet of die-cut stickers featuring different dog breeds, each with a white border and cute expressions, ready for printing.

---

## 9. AI Photography

**Context:** Photorealistic generation, lighting control, camera lenses, product photography.
...
## 10. AI Interior Design

**Context:** Interior spaces, room layouts, furniture styles, renovation ideas.

### Hero Section (Carousel)

**Ratio:** 9:16 (Portrait)

1. A wide shot of a luxurious modern living room with floor-to-ceiling windows overlooking a forest, featuring a beige sectional sofa and a fireplace, bathed in natural light.
2. A cozy, eclectic bedroom design with hanging plants, fairy lights, and a mix of vintage and modern furniture, creating a warm and inviting atmosphere.
3. A sleek, minimalist kitchen with matte black cabinets, white marble countertops, and gold fixtures, showcasing a high-end contemporary design.
4. A bright and airy Scandinavian-style dining room with a light oak table, wishbone chairs, and a large paper pendant light.

### Feature Section

**Ratio:** 16:9 (Landscape)

1. **Layout Visualization:** Three different furniture layout options for the same empty rectangular room, shown in top-down 3D views, illustrating different ways to utilize the space.
2. **Aesthetic Exploration:** A split image showing a living room, the left half designed in a rustic farmhouse style, and the right half in a sleek industrial style, showing the power of style swapping.
3. **Style Board Creation:** A digital mood board for a bathroom renovation, featuring samples of hexagonal tiles, brass faucets, towel textures, and a color palette of sage green and white.

### Showcase Section

**Ratio:** 16:9 (Landscape)

1. **Japandi Living Room Layout:** A serene living space blending Japanese minimalism and Scandinavian functionality, low-profile furniture, wood slats, and neutral earth tones.
2. **Modern Industrial Kitchen:** An industrial loft kitchen with exposed brick walls, concrete floors, stainless steel appliances, and large factory-style windows.
3. **Minimalist Master Bedroom:** A strictly minimalist bedroom with a platform bed, white walls, hidden storage, and a single piece of abstract art, emphasizing space and light.
4. **Skylit Bohemian Attic:** An attic converted into a bohemian lounge, with skylights, persian rugs, floor cushions, and macrame wall hangings.
5. **Luxury Marble Bathroom:** A spa-like bathroom completely clad in white Carrara marble, featuring a freestanding soaking tub, a rain shower, and ambient cove lighting.

---

## 11. AI Architecture

**Context:** Building concepts, exterior visualization, facades, urban planning.
