...
export function GenerationError({
    ...
    const title = React.useMemo(() => {
        ...
        switch (apiError.code) {
            ...
            case ClientErrorCode.GENERATION_FAILED:
    ...
    const variant: "destructive" | "default" =
        apiError?.isRetryable ? "default" : "destructive"
    ...
    const hasDetails =
        showDetails && (apiError?.requestId || apiError?.details?.stack)
                        ...
                        <CollapsibleContent className="mt-2 space-y-1">
                            ...
                            {apiError?.timestamp && (
                                <p className="text-xs text-muted-foreground">
                                    ...
                                    {apiError.timestamp.toLocaleTimeString()}
                                </p>
                            )}
                        </CollapsibleContent>
                    </Collapsible>
