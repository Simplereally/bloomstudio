...
import {
    ...
    PromptLibraryButton,
    SavePromptButton,
} from "@/components/studio/features/prompt-library"
import {
    ChevronDown,
    History,
    Lightbulb,
            ...
            <div className="space-y-2 w-full min-w-0">
                ...
                <div className="relative w-full min-w-0">
                    <Textarea
                        ...
                        maxLength={maxLength}
                        className="min-h-24 resize-none pr-8 pb-10 bg-background/50 border-border/50 focus:ring-2 focus:ring-primary/20 focus:border-primary/50 transition-all duration-200 break-words [overflow-wrap:anywhere] block w-0 min-w-full"
                ...
                {suggestions.length > 0 && (
                    <div className="flex flex-wrap gap-1.5" data-testid="suggestions">
                        <Lightbulb
                            className={`h-3.5 w-3.5 mt-1 transition-all duration-300 ${isLoadingSuggestions
                                ? "text-yellow-400 animate-lightbulb-glow"
                    ...
                    <CollapsibleContent className="pt-2">
                        <div className="relative w-full min-w-0">
                            <Textarea
                                ...
                                className="min-h-16 resize-none pb-10 bg-background/50 border-border/50 text-sm break-words [overflow-wrap:anywhere] block w-0 min-w-full"
