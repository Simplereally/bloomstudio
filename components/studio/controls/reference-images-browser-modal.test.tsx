...
describe("ReferenceImagesBrowserModal", () => {
  ...
  describe("rendering", () => {
    it("renders modal when open is true", () => {
      render(<ReferenceImagesBrowserModal open={true} onOpenChange={mockOnOpenChange} onSelect={mockOnSelect} />);
      expect(screen.getByRole("dialog")).toBeInTheDocument();
    });

    it("does not render modal when open is false", () => {
      render(<ReferenceImagesBrowserModal open={false} onOpenChange={mockOnOpenChange} onSelect={mockOnSelect} />);
    ...
    it("renders custom title", () => {
      render(
        <ReferenceImagesBrowserModal open={true} onOpenChange={mockOnOpenChange} onSelect={mockOnSelect} title="Select First Frame" />
      );
    ...
    it("renders description", () => {
      render(
        <ReferenceImagesBrowserModal open={true} onOpenChange={mockOnOpenChange} onSelect={mockOnSelect} description="Choose a reference" />
      );
