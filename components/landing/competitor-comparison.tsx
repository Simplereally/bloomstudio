        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[800px]">
            ...
            <tbody>
              ...
              {/* Flux Schnell Row - Our most efficient model */}
              <tr className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                <td className="p-4">
                  <div className="flex items-center gap-3">
                    {/* Flux Logo */}
                    ...
                    <div className="flex flex-col">
                      <span className="font-semibold text-foreground text-sm">Flux Schnell</span>
                      <span className="text-xs text-muted-foreground">Most efficient • 5000 images/pollen</span>
                    </div>
                  </div>
                </td>
