...
export function HeroSection({
    ...
    return (
        <section id="hero" className="relative pt-8 pb-20 sm:pt-12 sm:pb-28 lg:pb-32 xl:pb-36 xl:min-h-[75vh] 2xl:pb-40 2xl:min-h-[85vh] overflow-hidden flex flex-col justify-center">
