...
export const metadata: Metadata = {
  ...
  description:
    "Bloom Studio, a cheap and powerful AI image generator and video generator studio. Featuring Imagen 4, Grok Imagine, Grok Video, Flux Schnell, GPT Image, Z-Image, and FLUX.2 Klein. Try for free.",
