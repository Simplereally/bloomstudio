...
export default function PricingPage() {
    const jsonLd: WithContext<Product> = {
        ...
        description: "Professional AI image and video generation subscription. Includes up to 5,000 daily generations, all active models (Flux, GPT Image, Z-Image, Klein, Imagen 4, Grok Imagine, Grok Video), and private generations.",
