...
export const featureComparison = [
    ...
    { feature: "Queue priority", starter: "Zero artificial delays", pro: "Zero artificial delays", competitors: "Paid queue tiers" },
    {
        ...
        details: {
            ...
            cardDescription: "That's 600 concurrent requests per minute. We don't judge—if you want to blow your entire load in 18 seconds, our servers are ready for it.",
