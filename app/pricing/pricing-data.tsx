...
export const pricingTiers: PricingTier[] = [
    ...
    },
    {
        ...
        features: [
            ...
            "Daily resets",
            "9 AI models included (Flux Schnell, FLUX.2 Dev, GPT Image, Z-Image, Klein, Grok Imagine, Grok Video, and more)",
...
export const pricingFaqs = [
    ...
    },
    {
        ...
        answer: (
            <span>
                We offer 9 high-quality AI models including Flux Schnell, FLUX.2 Dev, GPT Image, Z-Image Turbo, FLUX.2 Klein, Imagen 4, Grok Imagine, and Grok Video. Both Free and Pro users get access to all active models.{" "}
