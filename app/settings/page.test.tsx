  ...
  api: {
    users: {
      ...
      updateSensitiveContentPreference:
        "users:updateSensitiveContentPreference",
    },
    stripe: {
...
vi.mock("framer-motion", () => ({
  motion: {
    ...
    aside: ({ children, className }: MotionDivProps) => (
...
describe("SettingsPage", () => {
  beforeEach(() => {
    ...
    mockUseMutation.mockImplementation(() => {
      ...
      return Object.assign(fn, {
        withOptimisticUpdate: vi.fn().mockReturnValue(fn),
      });
    });
  ...
  it("switches to Appearance view", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Customize the look and feel of your experience."),
      ).toBeInTheDocument();
